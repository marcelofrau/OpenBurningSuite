...
| 7 | 90 | `icons8-copy-2d` | 16px | Copy Disc | `Copy_Disc_icons8-copy-2d_16.png` |
| 8 | 97 | `icons8-create` | 16px | Build Image | `Build_Image_icons8-create_16.png` |
| 9 | 104 | `icons8-cd-3d` | 16px | Burn / Write | `Burn_Write_icons8-cd-3d_16.png` |
| 10 | 111 | `fluentui-check-mark-button` | 16px | Verify | `Verify_fluentui-check-mark-button_16.png` |
| 11 | 118 | `icons8-wizard-3d` | 16px | Advanced | `Advanced_icons8-wizard-3d_16.png` |
| 12 | 130 | `icons8-music-3d` | 16px | Audio &amp; Music Wizard | `Audio_amp_Music_Wizard_icons8-music-3d_16.png` |
| 13 | 138 | `icons8-video-editing-3d` | 16px | Video Disc Wizard | `Video_Disc_Wizard_icons8-video-editing-3d_16.png` |
| 14 | 146 | `icons8-folder` | 16px | Data Disc Wizard | `Data_Disc_Wizard_icons8-folder_16.png` |
| 15 | 154 | `icons8-game-controller` | 16px | Game Disc Wizard | `Game_Disc_Wizard_icons8-game-controller_16.png` |
| 16 | 161 | `icons8-duplicate-2d` | 16px | Copy Disc Wizard | `Copy_Disc_Wizard_icons8-duplicate-2d_16.png` |
| 17 | 168 | `icons8-erase` | 16px | Blank Disc Wizard | `Blank_Disc_Wizard_icons8-erase_16.png` |
| 18 | 205 | `icons8-cd-3d` | 50px | Burn Image | `Burn_Image_icons8-cd-3d_50.png` |
| 19 | 219 | `icons8-create` | 50px | Build Image | `Build_Image_icons8-create_50.png` |
...
| 27 | 335 | `icons8-create` | 50px | Build Disc Images | `Build_Disc_Images_icons8-create_50.png` |
